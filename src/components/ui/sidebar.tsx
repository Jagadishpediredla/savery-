    ...
    const desktopView = (
       <div
        ...
        className={cn(
          ...
          variant === "floating" && "data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4)_+2px)]",
          variant === "inset" && "data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4)_+2px)]",
          side === "left" ? "left-0" : "right-0",
          side === "left" && "data-[collapsible=offcanvas]:-left-[--sidebar-width]",
          side === "right" && "data-[collapsible=offcanvas]:-right-[--sidebar-width]",
          variant === "floating" && "p-2",
          variant === "inset" && "p-2",
          variant !== "floating" && variant !== "inset" && "data-[side=left]:border-r data-[side=right]:border-l",
          className
        )}
        data-state={state}
